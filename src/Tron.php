 ...
 * TronAPI
 *
 * @author  Shamsudin Serderov <adel.raheli@gmail.com>
 * @license https://github.com/artincms/tron-api/blob/master/LICENSE (MIT License)
 * @version 1.3.4
 * @link    https://github.com/artincms/tron-api
 *
...
use Elliptic\EC;
use artincms\TronAPI\Exception\TRC20Exception;
use artincms\TronAPI\Support\Base58;
use artincms\TronAPI\Support\Base58Check;
use artincms\TronAPI\Support\Crypto;
use artincms\TronAPI\Support\Hash;
use artincms\TronAPI\Support\Keccak;
use artincms\TronAPI\Support\Utils;
use artincms\TronAPI\Provider\HttpProviderInterface;
...
class Tron implements TronInterface
{
    ...
    private function set_url_variables(string $base_url, array $variables = [])
    {
